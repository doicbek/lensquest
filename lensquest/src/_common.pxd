...
cdef extern from "healpix_base.h":
	...
	cdef cppclass T_Healpix_Base[I]:
		...
		vec3 pix2vec(I pix)
		void get_ring_info(I ring, I &startpix, I &ringpix, double &costheta, double &sintheta, bool &shifted)
		void get_ring_info2(I ring, I &startpix, I &ringpix, double &theta, bool &shifted)
		void get_ring_info_small(I ring, I &startpix, I &ringpix, bool &shifted)
		void neighbors(I pix, fix_arr[I,val_8] &result)
		void get_interpol(pointing &ptg, fix_arr[I,val_4] &pix, fix_arr[double,val_4] &wgt)
		int Order()
		I Nside()
		I Npix()
		...
		void query_disc_inclusive(pointing ptg, double radius, rangeset[I]& pixset, int fact)
		void query_polygon(vector[pointing] vert, rangeset[I]& pixset) except +
		void query_polygon_inclusive(vector[pointing] vert, rangeset[I]& pixset, int fact) except +
		void query_strip(double theta1, double theta2, bool inclusive, rangeset[I]& pixset)
...
cdef extern from "powspec.h":
	cdef cppclass PowSpec:
		...
		void Set(arr[double] &tt_new, arr[double] &gg_new,arr[double] &cc_new, arr[double] &tg_new, arr[double] &gc_new, arr[double] &tc_new)
		double & tt(int l)
		double & gg(int l)
		double & cc(int l)
		double & tg(int l)
